...
feedforward_cuda.o:feedforward_cuda.cu
	$(EXEC) $(NVCC) $(INCLUDES) $(ALL_CCFLAGS) $(GENCODE_FLAGS) -o $@ -c $<
...
feedforward: feedforward.o feedforward_cuda.o loaddata.o
...
clean:
	rm -f feedforward feedforward.o feedforward_cuda.o  loaddata.o
	rm -rf ../../bin/$(OS_ARCH)/$(OSLOWER)/$(TARGET)$(if $(abi),/$(abi))/feedforward
